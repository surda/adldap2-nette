...
namespace Tests\Surda\Adldap\Utils;

use Surda\Adldap\Utils\Utils;
use Tester\Assert;
use Tester\TestCase;
...
class UtilsTest extends TestCase
{
    ...
    public function testWintime2Unixtime()
    {
        $wintime = 132917165326544247;
        $unixtime = 1647239333;

        Assert::same($unixtime, Utils::wintime2Unixtime($wintime));
    }
}
